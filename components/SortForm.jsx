...
const SortForm = () => {
  ...
  return (
    <form
      ...
      className="flex flex-col border border-purple-1 p-3 bg-white rounded-lg mt-4 mb-1 sm:flex-row sm:justify-between sm:pr-4"
    >
      ...
      <div className='flex flex-col sm:flex-row sm:items-center'>
        <select
          ...
          className="bg-white p-1.5 rounded-lg border border-purple-1 focus:outline-none focus:ring focus:ring-purple-2 text-purple-0 mt-1 hover:cursor-pointer sm:mx-4 sm:h-8 sm:mt-0"
        >
        ...
        <button
          type="submit"
          disabled={hasNoType}
          className="border border-purple-0 text-purple-0 rounded-lg hover:bg-purple-0 hover:text-white transition duration-200 w-full sm:px-2 disabled:cursor-not-allowed disabled:opacity-40 mt-2 sm:h-8 sm:w-24 sm:mt-0"
        >
          Ordenar
        </button>
      </div>
